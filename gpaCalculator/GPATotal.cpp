...
int GPATotal::checkInput(string* input, int maxInputSize, string errorMessage)
{
...
int GPATotal::checkValue(string* input, double minValue, double maxValue, string errorMessage)
{
