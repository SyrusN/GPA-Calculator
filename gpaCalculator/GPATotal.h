...
class GPATotal
{
   ...
   /**
    * Function         : int checkInput(string* input, int maxInputSize, string errorMessage);
    * Parameters       : string input, int maxInputSize, string errorMessage
    * Purpose          : To verify the input is valid
    * Pre-Condition    : An input is entered
    * Post-Condition   : The contents of the input are checked and an error message
    *                  :  is returned if invalid input is put in.
    * Return Value     : int
    * Functions Called : isalpha();
    */
   int checkInput(string* input, int maxInputSize, string errorMessage);

   /**
    * Function         : int checkValue(string* input, double minValue, double maxValue, string errorMessage);
    * Parameters       : string input, int maxInputSize, string errorMessage
    * Purpose          : To verify the input is validly within the min and max values
    * Pre-Condition    : An input is entered and the checkInput function has been executed on the input
    * Post-Condition   : The contents of the input are checked and an error message
    *                  :  is returned if invalid input range is put in.
    * Return Value     : int
    * Functions Called : isalpha();
    */
   int checkValue(string* input, double minValue, double maxValue, string errorMessage);
